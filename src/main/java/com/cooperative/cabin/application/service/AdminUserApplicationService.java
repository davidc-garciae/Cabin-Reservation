...
public interface AdminUserApplicationService {
    AdminUserResponse upsertUser(Long id, String email, String fullName, String role, boolean active);

    AdminUserResponse getProfile(Long userId);

    AdminUserResponse updateProfile(Long userId, String email, String fullName);
