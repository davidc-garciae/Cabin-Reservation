...
public record UpdateCabinRequest(
                ...
                @DecimalMin(value = "0.0", inclusive = false, message = "El precio base debe ser mayor a 0") @DecimalMax(value = "99999999.99", message = "El precio base no puede exceder 99999999.99 COP") @Schema(description = "Precio base por noche en pesos colombianos (COP)", example = "180000.00") BigDecimal basePrice,
