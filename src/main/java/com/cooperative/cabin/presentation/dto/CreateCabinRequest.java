...
public record CreateCabinRequest(
        ...
        @NotNull(message = "El precio base es obligatorio") @DecimalMin(value = "0.0", inclusive = false, message = "El precio base debe ser mayor a 0") @DecimalMax(value = "99999999.99", message = "El precio base no puede exceder 99999999.99 COP") @Schema(description = "Precio base por noche en pesos colombianos (COP)", example = "150000.00", required = true) BigDecimal basePrice,
        ...
        @Schema(description = "Hora de check-in por defecto", example = "15:00") String defaultCheckInTime,

        @Schema(description = "Hora de check-out por defecto", example = "11:00") String defaultCheckOutTime) {
}
